...
- [n]X 文字削除 BackSpace
- [C-a][C-x] 加算減算
- {d,y}[l,aw,ap] 削除かコピーを単一文字or単語or段落全体に適用する
- :7,20d 範囲削除
...
- [n]o 下の行にインサートモード
- [n]O 上の行にインサートモード
- [s] カーソル位置の文字をdeleteしてインサートモード
- [cw] カーソル位置の単語をdeleteしてインサートモード
- <C-w> 前の単語削除
- <C-u> カーソル位置から行頭まで削除
...
- [C-v] 矩形選択モードに入る
- [Shift-i] インサートモードに移行
    - 範囲選択した状態でインサートモードに入って文字入力して、インサートモード抜けると選択範囲に入力した文字が反映される
